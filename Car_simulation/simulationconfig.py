...
class SimulationConfig:
    ...
    def cars_position(self) -> list[tuple[int, int]]:
        return [
            (0 + 70, self.window_height / 2) for i in range(self.num_of_cars) 
    ...
    def map_types(self) -> list[str]:
        return ["slalom", "city", "bottleneck", "arena", "track"]
    ...
    # Stała paleta 15 kolorów dla wszystkich aut
        ...
        if map_type == "slalom":
            # Wszystkie cele na końcu toru (po prawej stronie, za ostatnią ścianą)
            points = [
                (1700, 100), (1700, 250), (1700, 400), (1700, 550), (1700, 700),
                (1800, 150), (1800, 300), (1800, 450), (1800, 600), (1800, 750),
                (1650, 150), (1650, 350), (1650, 650), (1650, 850), (1750, 850)
            ]

        elif map_type == "city":
            points = [
                (300, 100), (900, 100), (1500, 100), # Górna ulica
                (300, 500), (900, 500), (1500, 500), # Środkowa ulica
                (300, 900), (900, 900), (1500, 900), # Dolna ulica
                (100, 300), (100, 700),              # Lewa ulica
                (700, 300), (700, 700),              # Środkowa-lewa ulica
                (1300, 300), (1300, 700)             # Środkowa-prawa ulica
            ]
            ...
            points = [
                ...
                (600, 150), (600, 500), (400, 850),
                (1000, 150), (1000, 700), (1000, 900),
                (1400, 450), (1500, 850), (1600, 150),
                (1600, 500), (1600, 850), (800, 100)
            ]
        elif map_type == "track":
            points = [
                (950, 100),        # Czerwony
            ...
            points = [(100 + i*50, 100) for i in range(15)] # Fallback
